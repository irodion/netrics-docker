...
if [ "$CONTAINER_CMD" = "podman" ]; then
    $CONTAINER_CMD run -v ./volumes/netrics/result:/home/netrics/result:Z --rm -it --cap-add=NET_RAW $IMG_NAME bash
else
    $CONTAINER_CMD run -v ./volumes/netrics/result:/home/netrics/result --rm -it $IMG_NAME bash
fi
